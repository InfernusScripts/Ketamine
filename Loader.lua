...
local objects = {
    ...
    ["Instance186"] = Instance.new("Frame"); -- ScriptScanner
    ["Instance187"] = Instance.new("TextButton"); -- Hover
    ["Instance188"] = Instance.new("UICorner"); -- UICorner
    ["Instance189"] = Instance.new("Frame"); -- Overlay
    ["Instance190"] = Instance.new("UICorner"); -- UICorner
};
...
do -- Set properties
    ...
    objects["Instance186"]["Name"] = "ScriptScanner";
    objects["Instance186"]["BorderColor3"] = Color3.new(0, 0, 0);
    objects["Instance186"]["Parent"] = objects["Instance65"];
    objects["Instance186"]["Size"] = UDim2.new(1, 0, 1, 0);
    ...
    objects["Instance187"]["Name"] = "Hover";
    objects["Instance187"]["BackgroundTransparency"] = 1;
    objects["Instance187"]["Parent"] = objects["Instance30"];
    ...
    objects["Instance187"]["Size"] = UDim2.new(0.075000003, 0, 1, 0);
    ...
    objects["Instance188"]["CornerRadius"] = UDim.new(0.00999999978, 0);
    ...
    objects["Instance189"]["Parent"] = objects["Instance15"];
    objects["Instance189"]["ZIndex"] = 999999999;
    objects["Instance189"]["BorderSizePixel"] = 0;
    objects["Instance189"]["BackgroundColor3"] = Color3.new(0.105882, 0.105882, 0.105882);

    objects["Instance190"]["Parent"] = objects["Instance189"];
    objects["Instance190"]["CornerRadius"] = UDim.new(0.0149999997, 0);
end;
